defmodule Feedme.Test.Parsers.RSS2Stream do
  ...
  test "valid?", %{sample1: sample1, sample2: sample2, sample3: sample3, sample4: sample4} do
    ...
    assert RSS2Stream.valid?(sample1) == true
    assert RSS2Stream.valid?(sample2) == true
    assert RSS2Stream.valid?(sample3) == true
    assert RSS2Stream.valid?(sample4) == true
    assert RSS2Stream.valid?(wrong_doc) == false
  end
